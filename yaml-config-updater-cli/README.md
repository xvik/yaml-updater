...
[Download jar from maven central](https://repo1.maven.org/maven2/ru/vyarus/yaml-config-updater-cli/1.3.3/) (classifier `all`)
...
```groovy
implementation 'ru.vyarus:yaml-config-updater-cli:1.3.3'
```
